...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private void frg() {
        ...
        if (diagonalInches >= 6.5) {
            fragmentTransaction.replace(R.id.fragmentSh, searchFragment).replace(R.id.fragmentLt, mapSearchFragment);
        } else {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.mainList) {
            ...
            Intent intentDeleteAllFavorites = new Intent(this, DeleteAllDataFavoritesActivity.class);
            startActivity(intentDeleteAllFavorites);
        } else if (id == R.id.deleteAllDataHistory) {
            Intent intentDeleteAllHistory = new Intent(this, DeleteAllDataHistoryActivity.class);
