...
public class AddMarkerFavoritesActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.textViewOK:
                ...
                Intent intentAddInternetToMain = new Intent(AddMarkerFavoritesActivity.this, FavoritesActivity.class);
